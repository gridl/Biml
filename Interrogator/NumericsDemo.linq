		...
		while (!parser.EndOfData) 
		{
			...
			if(parser.LineNumber > 2) {
				switch(test) {
					case 1:
					//test1:bit
					if( NumericGuess(fields[0], false) != SqlDbType.Bit) {
					...
					case 2:
					//test2:TinyInt
					if( NumericGuess(fields[1]) != SqlDbType.TinyInt) {
					...
					case 3:
					//test3:SmallInt
					if( NumericGuess(fields[2]) != SqlDbType.SmallInt) {
					...
					case 4:
					//test4:Int
					if( NumericGuess(fields[3]) != SqlDbType.Int) {
					...
					case 5:
					//test5:BigInt
					if( NumericGuess(fields[4]) != SqlDbType.BigInt) {
					...
					case 6:
					//test6:Decimal
					if( NumericGuess(fields[5]) != SqlDbType.Decimal) {
					...
					case 7:
					//test7:Float
					if( NumericGuess(fields[6]) != SqlDbType.Float) {
